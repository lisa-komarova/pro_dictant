...
class _HeatMapCalendar extends State<HeatMapCalendar> {
  ...
  Widget _header() {
    List<String> monthLabels =
        DateUtil.MONTH_LABEL[Localizations.localeOf(context).languageCode] ??
            DateUtil.MONTH_LABEL['en']!;
    return Row(
      ...
      children: <Widget>[
        ...
        ExcludeSemantics(
          child: Text(
            monthLabels[_currentDate?.month ?? 0] +
                ' ' +
  ...
  Widget _weekLabel() {
    List<String> weekLabels =
        DateUtil.WEEK_LABEL[Localizations.localeOf(context).languageCode] ??
            DateUtil.WEEK_LABEL['en']!;
