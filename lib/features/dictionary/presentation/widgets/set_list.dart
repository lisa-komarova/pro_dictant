...
import '../pages/sets_words_page.dart';
...
class _SetListState extends State<SetList> {
  ...
  Widget buildSetsList(List<SetCardInfoEntity> sets) {
                      ...
                      return Dismissible(
                        ...
                        onDismissed: (DismissDirection direction) {
                          _showShouldDeleteSetDialog(
                              context, sets[index], index);
                        },
                        child: GestureDetector(
                          onTap: () async {
                            BlocProvider.of<SetBloc>(context)
                                .add(FetchSetWithWords(
                              setId: sets[index].id,
                            ));
                            ...
                            if (setToReplace != null) {
                              setState(() {
                                sets[index] = SetCardInfoEntity(
                                    id: setToReplace.id,
                                    name: setToReplace.name,
                                    numberOfWords:
                                        setToReplace.wordsInSet.length);
                              });
                            }
                          },
                          child: Padding(
  ...
  Future<void> _showShouldDeleteSetDialog(
      BuildContext context, SetCardInfoEntity set, int index) {
