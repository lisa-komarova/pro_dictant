...
class FetchWordsForMatchingTraining {
  final TrainingsRepository trainingsRepository;

  FetchWordsForMatchingTraining({required this.trainingsRepository});

  Future<Either<Failure, List<MatchingTrainingEntity>>> call() async {
    return await trainingsRepository.fetchWordsForMatchingTraining();
  }
}
